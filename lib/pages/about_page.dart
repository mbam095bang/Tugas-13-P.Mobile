          ...
          SingleChildScrollView(
            ...
            child: Column(
              ...
              children: [
                ...
                const CircleAvatar(
                  radius: 100,
                  backgroundImage: AssetImage("assets/images/bam.png"), // Path to your profile picture
                ...
                // Nama
                Text(
                  "MUHAMMAD BAMBANG IKHLASUL AMAL",
                  style: TextStyle(
                    fontSize: 28,
                    fontWeight: FontWeight.bold,
                ...
                // Info Pendidikan
                const Text(
                  "CLASS E INSTITUT TEKNOLOGI GARUT",
                  ...
                  child: Padding(
                    ...
                    child: Column(
                      children: [
                        ...
                        const SizedBox(height: 10),
                        InkWell(
                          onTap: () => _launchURL('mailto:2106095@itg.ac.id'),
                          child: Row(
                            mainAxisAlignment: MainAxisAlignment.center,
                            children: const [
